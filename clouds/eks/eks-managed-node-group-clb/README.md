...
The Makefile file is generated from the claude code to simply the terraform flow. This
project also adds a public-facing Classic Load Balancer (`clb.tf`) in front of the
managed node group instances on ports 80/443. Its documents are at:
